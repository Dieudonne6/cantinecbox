...
// Groupe de routes qui nécessitent l'accès à la base de données sélectionnée
Route::middleware(['switch.database.connection'])->group(function () {
    ...
    Route::post('/suppfacturescolaritenonnormalise/{id}', [PagesController::class, 'suppfacturescolaritenonnormalise'])->name('suppfacturescolaritenonnormalise');
    ...
    // Afficher le formulaire de modification du profil (accessible seulement si connecté)
...
Route::put('/agents/{matricule}', [InscrirepersonnelController::class, 'updateargent'])
    ...
    // Routes pour facture non normalisée
