...
class ClassesController extends Controller
{
    ...
    {
        $paiements = DB::table('paiementcontrat')->get();
        ...
        foreach ($paiements as $paiement) {
            try {
                ...
                Log::info("Facture générée avec succès pour le paiement ID: " . $paiement->id_paiementcontrat);
            } catch (\Exception $e) {
                // Gérer les erreurs de génération de facture
                Log::error("Erreur lors de la génération de la facture pour le paiement ID: " . $paiement->id_paiementcontrat . ". Détails: " . $e->getMessage());
            }
        }
    ...
    private function savepaiementcontrat2($paiement)
    {
        ...
        $montantmoiscontrat = $paiement->montant_paiementcontrat;
        $montanttotal = $nombreElements * ($paiement->montant_paiementcontrat);
        $datepaiementcontrat = $paiement->date_paiementcontrat;
        $id_usercontrat = $paiement->id_usercontrat;
