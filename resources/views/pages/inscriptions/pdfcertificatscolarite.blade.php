    ...
    <style>
        ...
        @media print {
            ...
            .watermark::before {
                ...
                left: -25%;
                width: 150%;
                height: 40px; /* Largeur de la ligne */
                background-color: red;
                transform: rotate(45deg); /* Inverser la direction de la ligne */
                z-index: 0;
                opacity: 0.8; /* Transparence de la ligne */
                pointer-events: none; /* Assure que le filigramme n'interfère pas avec le contenu */
                user-select: none;
            }
        }
        ...
        .content {
            ...
            line-height: 1.6;
            position: relative;
            z-index: 1; /* Assure que le contenu est au-dessus de la ligne */
        }
...
<body>
    <div class="container">
        ...
        <div class="certificate">
            ...
            <div class="content">
                <p>Le Directeur de <strong>{{ $nomecole->NOMETAB }}</strong> certifie que l'élève {{ $eleve->NOM }}
                    {{ $eleve->PRENOM }}, né(e) le {{ \Carbon\Carbon::parse($eleve->DATENAIS)->format('d/m/Y') }} à
                    {{ $eleve->LIEUNAIS }}, fils de {{ $eleveplus->NOMPERE }} {{ $eleveplus->prenompere }} et de
                    {{ $eleveplus->NOMMERE }} {{ $eleveplus->prenommere }}, est inscrit(e) dans notre établissement
