                    ...
                    <div class="col-3">
                        <select class="js-example-basic-multiple w-100" onchange="window.location.href=this.value">
                            ...
                            @foreach ($allClass as $classes)
                                <option value="filteraccueil/{{ $classes->CODECLAS }}">{{ $classes->CODECLAS }}</option>
                            @endforeach
                        </select>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="hide-printe">
                                            <div class="align-items-center">
                                                <a href="/pagedetail/{{ $eleve->MATRICULE }}" class="btn btn-primary p-2 btn-sm mr-2">Voir plus</a>
                                                <a class="btn btn-secondary p-2 btn-sm mr-2" href="{{ url('/paiementeleve/' . $eleve->MATRICULE) }}">Paiement</a>

                                                @if(empty($pagePermission['isReadOnly']) || $pagePermission['canManage'])
                                                <!-- bouton qui déclenche le menu -->
                                                <button class="btn btn-primary p-2 btn-sm js-dropdown-btn"
                                                        type="button"
                                                        data-menu-id="menu-{{ $eleve->MATRICULE }}">
                                                    <i class="typcn typcn-th-list btn-icon-append"></i>
                                                </button>

                                                <!-- source du menu (invisible dans le flow normal) -->
                                                <div class="js-dropdown-source d-none" id="menu-{{ $eleve->MATRICULE }}">
                                                    <ul class="dropdown-list">
                                                    <li><button class="dropdown-item delete-eleve" data-matricule="{{ $eleve->MATRICULE }}" data-nom="{{ $eleve->NOM }}" data-prenom="{{ $eleve->PRENOM }}" data-bs-toggle="modal" data-bs-target="#deleteModal">Supprimer</button></li>
                                                    ...
                                                    <li><a class="dropdown-item" href="/echeancier/{{ $eleve->MATRICULE }}">Echéance</a></li>
                                                    </ul>
                                                </div>
                                                @else
