                                            ...
                                            <div class="col-lg-4 d-none" id="percentage" style="margin-top: -3rem; background-color:rgb(207, 204, 204) !important;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="my-4 col-lg-12">
                                                        <button type="button" class="btn btn-secondary" style=" margin-left: 25%; margin-right: 25%;" id="closecalculate">Fermer le calculateur</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                                    ...
                                                                    <div class="" id="calcul-ones">
                                                                        <form class="forms-sample" id="modificationForm" action="{{ url('/modifreductions') }}" method="POST">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-12 mb-2">
                                                                                    <select class="js-example-basic-multiple w-50" id="reductionTypeModif" name="reductionType" required>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    //      MODAL MODIFICATION
    // ========================
    const reductionTypeModif = document.getElementById('reductionTypeModif');
    const avantScolaritemodif = document.getElementById('avantScolaritemodif');
    const apresScolaritemodif = document.getElementById('apresScolaritemodif');
    const reductionScolariteModif = document.getElementById('modalReductionScolarite');

    const avantArrieremodif = document.getElementById('avantArrieremodif');
    const apresArrieremodif = document.getElementById('apresArrieremodif');
    const reductionArriereModif = document.getElementById('modalReductionArriere');

    
    const avantFrais1modif = document.getElementById('avantFrais1modif');
    const apresFrais1modif = document.getElementById('apresFrais1modif');
    const reductionFrais1Modif = document.getElementById('modalReductionFrais1');

    
    const avantFrais2modif = document.getElementById('avantFrais2modif');
    const apresFrais2modif = document.getElementById('apresFrais2modif');
    const reductionFrais2Modif = document.getElementById('modalReductionFrais2');

    
    const avantFrais3modif = document.getElementById('avantFrais3modif');
    const apresFrais3modif = document.getElementById('apresFrais3modif');
    const reductionFrais3Modif = document.getElementById('modalReductionFrais3');

    
    const avantFrais4modif = document.getElementById('avantFrais4modif');
    const apresFrais4modif = document.getElementById('apresFrais4modif');
    const reductionFrais4Modif = document.getElementById('modalReductionFrais4');

    function updateModifCalcul() {
        if (reductionTypeModif.value == 2) { // Réduction fixe
            reductionScolariteModif.value = calculateFixe(parseFloat(avantScolaritemodif.value) || 0, parseFloat(apresScolaritemodif.value) || 0);
            reductionArriereModif.value = calculateFixe(parseFloat(avantArrieremodif.value) || 0, parseFloat(apresArrieremodif.value) || 0);
             reductionFrais1Modif.value = calculateFixe(parseFloat(avantFrais1modif.value) || 0, parseFloat(apresFrais1modif.value) || 0);
              reductionFrais2Modif.value = calculateFixe(parseFloat(avantFrais2modif.value) || 0, parseFloat(apresFrais2modif.value) || 0);
               reductionFrais3Modif.value = calculateFixe(parseFloat(avantFrais3modif.value) || 0, parseFloat(apresFrais3modif.value) || 0);
                reductionFrais4Modif.value = calculateFixe(parseFloat(avantFrais4modif.value) || 0, parseFloat(apresFrais4modif.value) || 0);
        } else { // Pourcentage
            reductionScolariteModif.value = calculatePercentage(parseFloat(avantScolaritemodif.value) || 0, parseFloat(apresScolaritemodif.value) || 0);
            reductionArriereModif.value = calculatePercentage(parseFloat(avantArrieremodif.value) || 0, parseFloat(apresArrieremodif.value) || 0);
             reductionFrais1Modif.value = calculatePercentage(parseFloat(avantFrais1modif.value) || 0, parseFloat(apresFrais1modif.value) || 0);
              reductionFrais2Modif.value = calculatePercentage(parseFloat(avantFrais2modif.value) || 0, parseFloat(apresFrais2modif.value) || 0);
               reductionFrais3Modif.value = calculatePercentage(parseFloat(avantFrais3modif.value) || 0, parseFloat(apresFrais3modif.value) || 0);
                reductionFrais4Modif.value = calculatePercentage(parseFloat(avantFrais4modif.value) || 0, parseFloat(apresFrais4modif.value) || 0);
        }
    }

    [avantScolaritemodif, apresScolaritemodif, avantArrieremodif, apresArrieremodif, avantFrais1modif, apresFrais1modif, avantFrais2modif,apresFrais2modif, avantFrais3modif, apresFrais3modif, avantFrais4modif, apresFrais4modif, reductionTypeModif]
        .forEach(el => el.addEventListener('input', updateModifCalcul));
    reductionTypeModif.addEventListener('change', updateModifCalcul);
});
