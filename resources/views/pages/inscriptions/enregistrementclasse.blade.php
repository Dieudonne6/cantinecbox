      ...
      <div class="card-body">
        ...
        <form  action="{{url('enregistrerclasse')}}" method="POST">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control"  name="nomclasse" id="exampleInputUsername2"
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="libclasse" id="exampleInputUsername2" placeholder="Libelle">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <select class="form-control js-example-basic-multiple w-100" id="exampleSelectGender">
