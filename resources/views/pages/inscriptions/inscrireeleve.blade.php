                ...
                <div class="card-body">
                  ...
                  <form class="accordion-body mx-auto">
                    <div class="form-group row mt-1">
                      ...
                      <div class="col-sm-3">
                        <select class="js-example-basic-multiple w-100" id="classe">
                          <option>CE1</option>
                          <option>Italy</option>
                      ...
                      <div class="col-sm-3">
                        <select class="js-example-basic-multiple w-100 select2-hidden-accessible" id="classe-entree">
                          <option>CM2</option>
                          <option>Italy</option>
                          <option>Russia</option>
                          <option>Britain</option>
                  ...
                  <form>
                    ...
                    <div class="form-group row mt-3">
                      ...
                      <div class="col-md-4">
                        ...
                        <select class="js-example-basic-multiple w-100" id="departement">
                          <option value="">Sélectionner</option>
