            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-12 mt-2 d-flex justify-content-end gap-2">
                        <button type="button" class="btn btn-sm btn-primary" onclick="impimerRecouvrement()">Imprimer</button>
                        <button type="button" class="btn btn-sm btn-primary" onclick="exportToExcel()">Exporter vers Excel</button>
                    </div>
                </div>
