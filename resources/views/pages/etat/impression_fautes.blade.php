...
<body>
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                {{-- <h4 class="card-title">Liste des fautes de {{ $eleve->NOM }} {{ $eleve->PRENOM }}</h4> --}}

                    <div>
                        <h4 class="card-title" style="text-align: center; font-weight:bold;">Liste des fautes de {{ $eleve->NOM }} {{ $eleve->PRENOM }}</h4>
                    </div><br>
