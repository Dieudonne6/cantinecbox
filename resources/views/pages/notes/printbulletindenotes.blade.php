        ...
        <div class="card">
            ...
            {{-- <div class="watermark"
                ...
                <div class="watermark"
                    ...
                    <div class="row"><button class="col-md-2 btn btn-primary" onclick="imprimerliste()">Imprimer</button></div>
                    <br>
                    @foreach ($resultats as $index => $resultat)
                        ...
                        <div class="bulletin"
                            ...
                            <div class="row" style="display: flex; align-items: flex-end;">
                                ...
                                <div class="col-md-3">
                                    <div id="carre"
                                        style="width: 145px; height: 140px; margin-bottom: 25px; background-color: transparent; border: 1px solid black; border-radius: 20px;">
                                    </div>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($resultat['matieres'] as $matiere)
                                        ...
                                        <tr style="white-space: nowrap;">
                                            ...
                                            @endif
                                            @if (!isset($option['note_test']) || !$option['note_test'])
                                                <td class="bold-text">{{ number_format($moyenne_sur_20, 2) ?? '**.**' }}
                                                </td>
