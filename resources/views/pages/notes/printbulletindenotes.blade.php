...
<br>
                    <div class="bulletin"
                        style=" position: relative; margin-bottom: 10px; {{ $index < count($resultats) - 1 ? 'page-break-after: always;' : '' }}">
                        ...
                        <div id="ligne" style="width: 0%; height: 0px; background-color: rgb(0, 0, 0);"></div>
                    </div>
                    ...
                    {{-- <div id="ligne" style="width: 0%; height: 1px; background-color: rgb(0, 0, 0);"></div> --}}
                    <div class="d-flex" style="height: 90px; margin-top: 5px;">
                        <div
                    ...
                    <div class="d-flex" style="margin-top: 10px;">
                        ...
                        <div id="appreciation"
                            ...
                            <div
                                style="flex: 1; display: flex; flex-direction: column; align-items: center; margin-top: 5px;">
