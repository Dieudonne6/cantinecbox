            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-3" style="border-right: 1px solid #000000 !important; width: 50% !important;">
                        ...
                        <div class="row"
                            style="background-color: #844fc1; color: #fff; border-radius: 8px; width: 100%;">
                        ...
                        <div class="row">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="bonification" id="intervalle"
                                    checked>
                        ...
                        <div class="row">
                            <div class="form-group d-flex">
                                <input type="number" class="form-control bonification-input"
                                    style="width: 28% !important" id="range0" name="range0" value="0"
                                    step="0.25">
                                <p style="margin-top: 10px;">--</p>
                                <input type="number" class="form-control bonification-input"
                                    style="width: 28% !important" id="range1" name="range1" value="11"
                                    step="0.25">
                                <p style="margin-top: 10px;">--></p>
                                <input type="number" class="form-control bonification-input"
                                    style="width: 28% !important" id="value1" name="value1" value="1"
                                    step="0.25">
                            </div>
                            <div class="form-group d-flex">
                                <input type="number" class="form-control bonification-input"
                                    style="width: 28% !important" id="range2" name="range2" value="11"
                                    step="0.25">
                                <p style="margin-top: 10px;">--</p>
                                <input type="number" class="form-control bonification-input"
                                    style="width: 28% !important" id="value2" name="value2" value="12"
                                    step="0.25">
                                <p style="margin-top: 10px;">--></p>
                                <input type="number" class="form-control bonification-input"
                                    style="width: 28% !important" id="value2" name="value2" value="2"
                                    step="0.25">
                            </div>
                            <div class="form-group d-flex">
                                <input type="number" class="form-control bonification-input"
                                    style="width: 28% !important" id="range3" name="range3" value="12"
                                    step="0.25">
                                <p style="margin-top: 10px;">--</p>
                                <input type="number" class="form-control bonification-input"
                                    style="width: 28% !important" id="value3" name="value3" value="14"
                                    step="0.25">
                                <p style="margin-top: 10px;">--></p>
                                <input type="number" class="form-control bonification-input"
                                    style="width: 28% !important" id="value3" name="value3" value="3"
                                    step="0.25">
                            </div>
                            <div class="form-group d-flex">
                                <input type="number" class="form-control bonification-input"
                                    style="width: 28% !important" id="range4" name="range4" value="14"
                                    step="0.25">
                                <p style="margin-top: 10px;">--</p>
                                <input type="number" class="form-control bonification-input"
                                    style="width: 28% !important" id="value4" name="value4" value="3"
                                    step="0.25">
                                <p style="margin-top: 10px;">--></p>
                                <input type="number" class="form-control bonification-input"
                                    style="width: 28% !important" id="value4" name="value4" value="4"
                                    step="0.25">
                            </div>
                            <div class="form-group d-flex">
                                <input type="number" class="form-control bonification-input"
                                    style="width: 28% !important" id="range5" name="range5" value="16"
                                    step="0.25">
                                <p style="margin-top: 10px;">--</p>
                                <input type="number" class="form-control bonification-input"
                                    style="width: 28% !important" id="value5" name="value5" value="4"
                                    step="0.25">
                                <p style="margin-top: 10px;">--></p>
                                <input type="number" class="form-control bonification-input"
                                    style="width: 28% !important" id="value5" name="value5" value="5"
                                    step="0.25">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" style="width: 30% !important" id="effectif"
                                    name="effectif" value="0" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6" style="border-right: 1px solid #000000 !important;">
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-example-basic-multiple custom-select-width w-auto" id="typeenseigne"
                                name="typeenseigne">
                        ...
                        <div class="d-flex justify-content-center align-items-center"
                            style="margin-right: 70px !important; gap: 20px;">
                            <p class="mb-0" style="white-space: nowrap;">À partir de :</p>
                            <input type="text" class="form-control" id="apartirde" name="apartirde"
                            ...
                            <div class="table-responsive mb-4">
                                <table id="tableClasses" class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($classes as $classe)
                                            <tr>
                                                <td><input type="checkbox" name="selected_classes[]"
                                                        value="{{ $classe->CODECLAS }}"
                                                        style="margin-left: 10px !important; margin-top: -7px !important;">
                                                </td>
                                ...
                                <table class="table table-striped display" id="myTab" style="width: 70% !important;">
                                    <thead>
                                        <tr>
                                            <th style="width: 10% !important;">
                                                <input type="checkbox" name="selected_eleves[]" value="all"
                                                    style="margin-left: 9px !important; margin-top: -15px !important;"
                                                    onclick="selectAllCheckboxes1(this)">
                                            </th>
                                            <th>Nom</th>
                                            <th>Prénom</th>
                                            <th>Classe</th>
                                    ...
                                    <tbody>
                                        @foreach ($eleves as $eleve)
                                            <tr>
                                                <td><input type="checkbox" name="selected_eleves[]"
                                                        value="{{ $eleve->MATRICULE }}"></td>
                                                <td>{{ $eleve->NOM }}</td>
                                                <td>{{ $eleve->PRENOM }}</td>
                        ...
                        <div class="row">
                            ...
                            <body>
                                ...
                                <div class="toolbar">
                                    ...
                                    <!-- Boutons de style -->
                                    <button class="icon" onclick="document.execCommand('bold', false, '')">G</button>
                                    <!-- Gras -->
                                    <button class="icon" onclick="document.execCommand('italic', false, '')">I</button>
                                    <!-- Italique -->
                                    <button class="icon"
                                        onclick="document.execCommand('underline', false, '')">S</button> <!-- Souligné -->
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="row">
                            <button class="btn btn-secondary" data-bs-toggle="modal"
                                data-bs-target="#optionsEdition">Afficher les options d'édition</button>
                        </div>
                        <br>
                        <div class="row"
                            ...
                            <div class="form-group d-flex align-items-center">
                                ...
                                <input type="number" class="form-control" id="eps" name="eps" value="0"
                                    style="margin-left: 10px; width: 50px !important; padding: 0; height: 2rem;">
                                <button class="btn btn-primary"
                                    style="margin-left: 5px !important;padding: 0.5rem;background-color: #fff; color: #000;"
                                    data-bs-toggle="modal" data-bs-target="#listematiere">Voir</button>
                        ...
                        <div class="row">
                            <button class="btn btn-primary mb-2" data-bs-toggle="modal"
                                data-bs-target="#configdecisionconseil">Configurer les bulletins</button>
                            <br>
                        ...
                        <br>
                        <div class="row"
                            style="background-color: #844fc1; border: 1px solid #ffffff; border-radius: 4px; color: #fff;">
                            ...
                            <div class="">
                                <div class="form-group d-flex justify-content-between mb-2">
                                    ...
                                    <input type="number" class="form-control" id="felicitation" name="felicitation"
                                        value="0"
                                        style="margin-left: 10px; width: 50px !important; padding: 0; height: 2rem;">
                                </div>
                                <div class="form-group d-flex justify-content-between mb-2">
                                    <label for="encouragements">Encouragements</label>
                                    <input type="number" class="form-control" id="encouragements" name="encouragements"
                                        value="0"
                                        style="margin-left: 10px; width: 50px !important; padding: 0; height: 2rem;">
                                </div>
                                <div class="form-group d-flex justify-content-between mb-2">
                                    <label for="tableaudhonneur">Tableau d'honneur</label>
                                    <input type="number" class="form-control" id="tableaudhonneur"
                                        name="tableaudhonneur" value="0"
                                        style="width: 50px !important; padding: 0; height: 2rem;">

                                </div>
                                <div class="form-group d-flex justify-content-between mb-2">
                                    <label for="avertissement">Avertissement/Travail</label>
                                    <input type="number" class="form-control" id="avertissement" name="avertissement"
                                        value="0" style="width: 50px !important; padding: 0; height: 2rem;">
                                </div>
                                <div class="form-group d-flex justify-content-between mb-1">
                                    <label for="blame">Blâme/Travail</label>
                                    <input type="number" class="form-control" id="blame" name="blame"
                                        value="0" style="width: 50px !important; padding: 0; height: 2rem;">
                                </div>
                            </div>
                        </div>
                        <div class="row"
                            ...
                            <legend style="font-weight: bold; color: #fff; font-size: 1rem;">Calcul moyenne annuelle
                            </legend>
                            <div class="form-group d-flex align-items-center mb-2">
                                ...
                                <input type="number" class="form-control" id="pondTrim1" name="pondTrim1"
                                    value="0"
                                    style="margin-left: 10px; width: 50px !important; padding: 0; height: 2rem;">
                                <input type="checkbox" class="form-check-input" name="pondTrim1" id="pondTrim1"
                            ...
                            <div class="form-group d-flex align-items-center mb-2">
                                ...
                                <input type="number" class="form-control" id="pondTrim2" name="pondTrim2"
                                    value="0"
                                    style="margin-left: 10px; width: 50px !important; padding: 0; height: 2rem;">
                                <input type="checkbox" class="form-check-input" name="pondTrim2" id="pondTrim2"
                                    style="right: 1rem !important;">
                            </div>
                            <div class="form-group d-flex align-items-center mb-1">
                                ...
                                <input type="number" class="form-control" id="pondTrim3" name="pondTrim3"
                                    value="0"
                                    style="margin-left: 10px; width: 50px !important; padding: 0; height: 2rem;">
                                <input type="checkbox" class="form-check-input" name="pondTrim3" id="pondTrim3"
                                    style="right: 1rem !important;;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label edition-label" for="matricule">Imprimer le matricule sur le
                                    bulletin</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="annuler_matiere"
                                    id="annuler_matiere">
                                <label class="form-check-label edition-label" for="annuler_matiere">Annuler la matière si
                                    aucun devoir</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="photo_par_logo"
                                    id="photo_par_logo">
                                <label class="form-check-label edition-label" for="photo_par_logo">Remplacer la photo par
                                    le logo</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-check">
                                ...
                                <label class="form-check-label edition-label" for="note_test">Gérer la note de Test (ou
                                    Compo)</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="mention_conseil"
                                    id="mention_conseil">
                                <label class="form-check-label edition-label" for="mention_conseil">Cocher les mentions du
                                    conseil</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="decision_conseil"
                                    id="decision_conseil">
                                <label class="form-check-label edition-label" for="decision_conseil">Imprimer la décision
                                    du conseil</label>
                            </div>
                            <div class="form-check">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const updateUI = () => {
                ...
                const selectionInputs = selectionBlock.querySelectorAll(
                'input'); // Sélectionner tous les inputs dans le bloc
                ...
                if (selectedOption === 'calculMoyennes') {
                    selectionInputs.forEach(input => input.disabled =
                    true); // Désactiver les inputs dans le bloc de sélection
