            ...
            <fieldset style="border: 2px solid #ff000067 !important; border-radius: 5px !important; background-color: #ff950059;">
                <div class="row">
                    <div class="form-group d-flex align-items-center" style="margin-top: 10px !important;">
                        ...
                        <select class="form-select" id="periode" name="periode" style="margin-left: 20px !important; width: 250px !important;">
                    ...
                    <div class="form-group d-flex align-items-center">
                        ...
                        <input type="number" class="form-control w-25" id="interligne" name="interligne" value="0.1" style="margin-left: 20px !important;">
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="form-group d-flex align-items-center">
                        ...
                        <input type="number" class="form-control" id="conduite" name="conduite" value="0" style="margin-left: 20px !important; width: 80px !important;">
                        <button class="btn btn-primary" style="margin-left: 10px !important;" data-bs-toggle="modal" data-bs-target="#listematiere">Voir</button>
                    </div>
                    <br>
                    <div class="form-group d-flex align-items-center">
                        <label for="eps">Quel est le n° de EPS ?</label>
                        <input type="number" class="form-control" id="eps" name="eps" value="0" style="margin-left: 62px !important; width: 80px !important;">
                        <button class="btn btn-primary" style="margin-left: 10px !important;" data-bs-toggle="modal" data-bs-target="#listematiere">Voir</button>
                    </div>
                    <div class="form-group d-flex align-items-center">
                        <label for="nbabsence">Nb. Absence autorisée</label>
                        <input type="number" class="form-control w-25" id="nbabsence" name="nbabsence" value="0" style="margin-left: 37px !important;">
                    </div>
                ...
                <fieldset style="background-color: #ff950087; border: 3px solid #ffffff; border-radius: 10px; width: 100%;">
                    ...
                    <div class="d-flex justify-content-around flex-wrap">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.25" class="form-control" id="felicitation" name="felicitation" value="0" style="width: 90px; height: 40px;">
                        </div>
                        <div class="form-group">
                            <label for="encouragements">Encouragements</label>
                            <input type="number" step="0.25" class="form-control" id="encouragements" name="encouragements" value="0" style="width: 90px; height: 40px;">
                        </div>
                        <div class="form-group">
                            <label for="tableaudhonneur">Tableau d'honneur</label>
                            <input type="number" step="0.25" class="form-control" id="tableaudhonneur" name="tableaudhonneur" value="0" style="width: 90px; height: 40px;">
                        </div>
                        <div class="form-group">
                            <label for="avertissement">Avertissement/Travail</label>
                            <input type="number" step="0.25" class="form-control" id="avertissement" name="avertissement" value="0" style="width: 90px; height: 40px;">
                        </div>
                        <div class="form-group">
                            <label for="blame">Blâme/Travail</label>
                            <input type="number" step="0.25" class="form-control" id="blame" name="blame" value="0" style="width: 90px; height: 40px;">
                        </div>
                    </div>
                </fieldset>
            </div>
