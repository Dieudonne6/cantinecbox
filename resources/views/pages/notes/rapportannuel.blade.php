        ...
        <div class="card">
                    ...
                    <div class="card shadow-sm p-1 rounded" style="background-color: #f8f9fa;">
                        <div class=" gap-5" style="display: flex; flex-wrap: nowrap; justify-content:center;">
                            ...
                            <button class="btn btn-outline-secondary btn-sm fw-bold " type="button"
                                onclick="printTable()">Imprimer rapport</button>
                            <button id="btnToggle"
                                class="btn btn-outline-primary btn-sm fw-bold ">Afficher/ignorer</button>
            ...
            <div id="rapportData" style="display: none;">
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    <div
                        style="border: 1px solid #333; padding: 10px; background-color: rgb(185,185,185); border-radius: 8px;">
                    ...
                    <div>
                        <img src="data:image/png;base64,{{ base64_encode($params2[0]->logoimage ?? '') }}" alt="Logo"
                            width="60">
                    </div>
                </div>
